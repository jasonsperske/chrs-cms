    ...
    messages: [
      {
        role: "system",
        content:
          ['I have pictures of a book or possibly a magazine. Respond in the',
            ...
            'one interpretations, give me these multiple interpretations with a confidence',
            'score between 0 and 1.'].join(' '),
      },
      {
        role: "user",
